...
export const Plus = ({ size, color }: Props) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={size} height={size} viewBox='0 0 24 24'>
    <g>
      <path
        d='M18.438,20.937H5.562c-1.379,0-2.5-1.122-2.5-2.5V5.563c0-1.378,1.121-2.5,2.5-2.5h12.875
      ...
      />
      <path
        d='M14.999,12.499h-2.5v2.5c0,0.64-1,0.64-1,0v-2.5h-2.5c-0.64,0-0.64-1,0-1h2.5v-2.5
